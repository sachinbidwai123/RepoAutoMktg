...
<div id="body">
<div class="contain">
<p class="SubHead">Auto investment</p>
...
<div class="heading"><span class="headText">Plan-01</span></div>
...
<ul class="planBullet">
    ...
    <li>Type specimen book</li>
    <li>It has survived</li>
</ul>
<div class="clear"></div> 
<input class=" myButtBlue" type="button" value="BUY NOW" name="input" onclick="location.href='investors-login.php';">
        </div>
    </li>
    <li>
    	<div class="investMainBox">
...
<input class=" myButtBlue" type="button" value="BUY NOW" name="input" onclick="location.href='investors-login.php';">
    ...
    <li>
    	<div class="investMainBox">
<div class="heading"><span class="headText">Plan-03</span></div>
<p class="blk1">Lorem Ipsum is simply dummy text of the Lorem Ipsum is simply dummy</p>
<p class="blueText1">Lorem Ip-simply the Lorem</p>
<ul class="planBullet">
	<li> Lorem Ipsum is simply </li>
    <li>Dummy text of the printing and</li>
    <li>typesetting industry</li>
    ...
    <li>Galley of type</li>
    <li>Scrambled it to make</li>
    <li>Type specimen booked</li>
</ul>
<div class="clear"></div> 
<input class=" myButtBlue1112" type="button" value="BUY NOW" name="input" onclick="location.href='investors-login.php';">
        </div>
    </li>
</ul>
</div>
