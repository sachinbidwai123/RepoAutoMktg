...
<div id="body">
<div class="contain">
<p class="SubHead">Car part on auction </p>
<div id="whiteCupn">
  <div id="boxLeftCup">
...
<div class="lableData">
 ...
 <div class="clear"></div>
  ...
  <div id="boxRightCup" class="bgNone">
    <div class="couponBox">
          <p class="couponHead">  Browse car part on Auction  </p>
      ...
      <span class="lable">Name of the part</span>
      <div class="lableData">
        <input name="" type="text"  class="mySearch">
      </div>
      </div>
    ...
    <div class="auctBox">
    	 <div class="detailBoxIn">
                ...
                <div class="cupCarPic"> <a href="auction-details.php"><img border="0" alt="car" src="images/car-part.jpg"></a> </div>
