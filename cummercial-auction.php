...
<div id="body">
<div class="contain">
<p class="SubHead">Commercial vehicles on auction</p>
<div id="whiteCupn">
  <div id="boxLeftCup">
    <div class="commonBox dottedBor">
      ...
      <div class="lableData">
        <ul class="auctionPanel">
          <li class="mycategory"><a href="#" class="ctgryLonk"> Cars or truck on auction </a></li>
          <li class="mycategory"><a href="#" class="ctgryLonk"> Commercial trucks on auction   </a></li>
          <li class="mycategory"><a href="#" class="ctgryLonk"> Motorcycles  on  auction  </a></li>
          <li class="mycategory"><a href="#" class="ctgryLonk"> Car parts on auction  </a></li>
        </ul>
      </div>     
