...
<div id="body">
<div class="contain">
<p class="SubHead">Motorcycle on auction </p>
<div id="whiteCupn">
  <div id="boxLeftCup">
...
<div class="lableData">
 ...
 <div class="clear"></div>
  ...
  <div id="boxRightCup" class="bgNone">
    <div class="couponBox">
          <p class="couponHead">  Browse Motorcycle on Auction  </p>
      ...
      <div class="auctBox">
            <span class="lable">Zip code: </span>
      <div class="lableData">
        <input type="text" class="mySearch" name="">
      </div>
      <span class="lable">Within: </span>
      <div class="lableData">
        <input type="text" class="mySearch" name="">
    ...
    <div class="auctBox">
    	 <div class="detailBoxIn">
                ...
                <div class="cupCarPic"> <a href="auction-details.php"><img border="0" alt="car" src="images/bike.jpg"></a> </div>
