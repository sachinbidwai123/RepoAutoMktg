...
<div id="body">
<div class="contain">
<p class="SubHead">On sale this month</p>
<div id="whiteCupn">
...
Learn how it works
    ...
    <div class="ctlogHead">Browse cars on sale. Buy now and save</div>
    <div class="makeModcoup">
      <div class="subCupBox">
        	<div class="detailBoxIn">
            <p>Honda pilot 2006 </p>
            <p class="blueText1">Listing price: $10000.00</p>
            <div class="cupCarPic">
            <a href="car-details.php"><img src="images/car.jpg" alt="car" border="0"></a>
            </div>
            <p class="salwPrice"><a href="car-details.php">On sale  for: $8500.00</a></p>
            <p class="viewNo"><a href="car-details.php">Offer expires: 04/31/15</a></p>
